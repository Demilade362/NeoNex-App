      ...
      <section className="container mx-auto mt-10">
        <div className="flex flex-col-reverse lg:flex-row justify-between items-center">
          <div className="flex-col lg:p-10">
            {/* <h1 className="text-4xl mb-5 text-pretty bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-yellow-500">Contact NeoNex</h1> */}
            <div class="w-full max-w-full p-4 bg-white border border-gray-200 rounded-lg sm:p-6 text-black">
              ...
              <ul class="my-4 space-y-3">
                ...
                <li>
                  <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow text-purple-400">
                ...
                <li>
                  <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow text-blue-400">
                ...
                <li>
                  <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow text-green-400">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16" className="text-green-400">
